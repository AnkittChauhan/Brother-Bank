            ...
            {viewImage && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4" onClick={() => setViewImage(null)}>
                    <div className="relative max-w-3xl w-full" onClick={e => e.stopPropagation()}>
                        ...
                        <img src={`${API_URL}${viewImage}`} alt="Document" className="w-full rounded-2xl shadow-2xl" />
                    </div>
                </div>
            )}
                                ...
                                <div key={loan._id} className="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
                                    <div className="p-6">
                                        ...
                                        <div className="flex gap-3 mb-4">
                                            <button onClick={() => setViewImage(loan.signature)} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all text-sm text-gray-600">
                                                <Eye className="w-4 h-4" /> View Signature
                                            </button>
                                            <button onClick={() => setViewImage(loan.documentPhoto)} className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gray-50 border border-gray-200 hover:border-blue-300 hover:bg-blue-50 transition-all text-sm text-gray-600">
